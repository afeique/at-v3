...
{
$count_fd6e5c1661e0d0c392a56dc7cc16f669 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_fd6e5c1661e0d0c392a56dc7cc16f669]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_fd6e5c1661e0d0c392a56dc7cc16f669]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_fd6e5c1661e0d0c392a56dc7cc16f669]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_fd6e5c1661e0d0c392a56dc7cc16f669]['extraData'] = $extraData;
}
...
{
$count_aeffa8e7cc0eb75f8bf19a2cca7d6054 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['formField'] = $formField;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['content'] = $content;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['options'] = $options;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_aeffa8e7cc0eb75f8bf19a2cca7d6054]['showEditor'] = $showEditor;
}
...
{
$count_febdf6a8825e8afbeaf364143578a2a6 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_febdf6a8825e8afbeaf364143578a2a6]['options'] = $options;
$this->functionData['editorLoadJs'][$count_febdf6a8825e8afbeaf364143578a2a6]['inlineLoad'] = $inlineLoad;
}
...
{
$count_de455b355975be63731b286ccb8baec7 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_de455b355975be63731b286ccb8baec7]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_de455b355975be63731b286ccb8baec7]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_de455b355975be63731b286ccb8baec7]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_de455b355975be63731b286ccb8baec7]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__8910ddfed3bfd43a0fd6bed11f4757f8($rows,$pages,$app,$plugin)."		") : ("
...
function __f__8910ddfed3bfd43a0fd6bed11f4757f8($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_748b41f170410f21cb7755a84c102da1 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_748b41f170410f21cb7755a84c102da1]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__67dace2181d675fe783c14c81250fedf($tabs)."			</ul>
		</div>
...
function __f__67dace2181d675fe783c14c81250fedf($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
