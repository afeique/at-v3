...
{
$count_6aac80b624b8f636d40153732a7ff116 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_6aac80b624b8f636d40153732a7ff116]['r'] = $r;
$this->functionData['comment'][$count_6aac80b624b8f636d40153732a7ff116]['parent'] = $parent;
$this->functionData['comment'][$count_6aac80b624b8f636d40153732a7ff116]['settings'] = $settings;
}
...
{
$count_9743add864a1ecd03f98632e4f1efbf6 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_9743add864a1ecd03f98632e4f1efbf6]['r'] = $r;
$this->functionData['commentHidden'][$count_9743add864a1ecd03f98632e4f1efbf6]['parent'] = $parent;
$this->functionData['commentHidden'][$count_9743add864a1ecd03f98632e4f1efbf6]['settings'] = $settings;
}
...
{
$count_42235ddb227f31fd45baa59f826e0f9f = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_42235ddb227f31fd45baa59f826e0f9f]['comments'] = $comments;
$this->functionData['commentsList'][$count_42235ddb227f31fd45baa59f826e0f9f]['settings'] = $settings;
$this->functionData['commentsList'][$count_42235ddb227f31fd45baa59f826e0f9f]['pages'] = $pages;
$this->functionData['commentsList'][$count_42235ddb227f31fd45baa59f826e0f9f]['parent'] = $parent;
$this->functionData['commentsList'][$count_42235ddb227f31fd45baa59f826e0f9f]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__1dce54136a8ab94ef5d296fd9acfaa86($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__1dce54136a8ab94ef5d296fd9acfaa86($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_065c468b0badcde49771f99af4822936 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_065c468b0badcde49771f99af4822936]['comment'] = $comment;
$this->functionData['form'][$count_065c468b0badcde49771f99af4822936]['parent'] = $parent;
$this->functionData['form'][$count_065c468b0badcde49771f99af4822936]['editor'] = $editor;
$this->functionData['form'][$count_065c468b0badcde49771f99af4822936]['settings'] = $settings;
$this->functionData['form'][$count_065c468b0badcde49771f99af4822936]['errors'] = $errors;
$this->functionData['form'][$count_065c468b0badcde49771f99af4822936]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
