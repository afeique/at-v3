...
{
$count_baa4d847193283ac847fe33dbdd2d382 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_baa4d847193283ac847fe33dbdd2d382]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_baa4d847193283ac847fe33dbdd2d382]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_baa4d847193283ac847fe33dbdd2d382]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_baa4d847193283ac847fe33dbdd2d382]['sharelinks'] = $sharelinks;
}
...
{
$count_3154ed6fd1e432d1f72222775da98ee8 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_3154ed6fd1e432d1f72222775da98ee8]['announce'] = $announce;
$this->functionData['announcement_show'][$count_3154ed6fd1e432d1f72222775da98ee8]['author'] = $author;
}
...
{
$count_424dbd0aae81d2898f5c2e59ae3880a0 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_424dbd0aae81d2898f5c2e59ae3880a0]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_424dbd0aae81d2898f5c2e59ae3880a0]['forum'] = $forum;
}
...
{
$count_ce6f1925af063866044cdbbf4e422251 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_4a465c6a1648b1a530326665976f4bef = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_4a465c6a1648b1a530326665976f4bef]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_4a465c6a1648b1a530326665976f4bef]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_4a465c6a1648b1a530326665976f4bef]['opts'] = $opts;
}
...
{
$count_0732411055038039ebcd2ff5923d0152 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_0732411055038039ebcd2ff5923d0152]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_0732411055038039ebcd2ff5923d0152]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_0732411055038039ebcd2ff5923d0152]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_0732411055038039ebcd2ff5923d0152]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_0732411055038039ebcd2ff5923d0152]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_0732411055038039ebcd2ff5923d0152]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__21d97ea9c60aecb68afcdce81b64165c($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__aae8a85d26e7a3321489462c5f4c3140($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a40810614c0e7470bda71c8338376824($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__aae8a85d26e7a3321489462c5f4c3140($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__21d97ea9c60aecb68afcdce81b64165c($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__a40810614c0e7470bda71c8338376824($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_e8d4eb2777c83731387aa5dff9ae30d7 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_e8d4eb2777c83731387aa5dff9ae30d7]['post'] = $post;
$this->functionData['post'][$count_e8d4eb2777c83731387aa5dff9ae30d7]['displayData'] = $displayData;
$this->functionData['post'][$count_e8d4eb2777c83731387aa5dff9ae30d7]['topic'] = $topic;
$this->functionData['post'][$count_e8d4eb2777c83731387aa5dff9ae30d7]['forum'] = $forum;
}
...
{
$count_6eb0db3e95634577224798ef3bf8d9fc = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_6eb0db3e95634577224798ef3bf8d9fc]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_75dc157d8b09f970997758f574a54967 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_75dc157d8b09f970997758f574a54967]['title'] = $title;
$this->functionData['show_attachment_title'][$count_75dc157d8b09f970997758f574a54967]['data'] = $data;
$this->functionData['show_attachment_title'][$count_75dc157d8b09f970997758f574a54967]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__a9b59bb82eb446798457738c1b546ba6($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__a9b59bb82eb446798457738c1b546ba6($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3e8f497ce26014808c7c441bc678cd02 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_3e8f497ce26014808c7c441bc678cd02]['data'] = $data;
}
...
{
$count_da51a2446a058b37ec651ac18bc08738 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_da51a2446a058b37ec651ac18bc08738]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_da51a2446a058b37ec651ac18bc08738]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_da51a2446a058b37ec651ac18bc08738]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__97815f917b8e521a49c88d9dd4634fa2($topic,$posts)."<br class='clear' />
...
function __f__97815f917b8e521a49c88d9dd4634fa2($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0a6feeda49b36294c28c820a5c9ef16c = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_0a6feeda49b36294c28c820a5c9ef16c]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_0a6feeda49b36294c28c820a5c9ef16c]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_0a6feeda49b36294c28c820a5c9ef16c]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_0a6feeda49b36294c28c820a5c9ef16c]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__2332dcfaff71206dc730667c8cb866cf($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__166d71f294955360a77a9e368ae816de($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__3608f451f05b84e712d960eb385eaed0($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__ecb425997a93457412250b05026bd313($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__9c35896a805c0e899016a3c8e2ffe5e4($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__2332dcfaff71206dc730667c8cb866cf($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__166d71f294955360a77a9e368ae816de($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3608f451f05b84e712d960eb385eaed0($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ecb425997a93457412250b05026bd313($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9c35896a805c0e899016a3c8e2ffe5e4($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
