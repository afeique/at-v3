...
{
$count_f0294cd8c7c06632a8212c4c830a75b3 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_f0294cd8c7c06632a8212c4c830a75b3]['data'] = $data;
}
...
{
$count_53ddecad911c3e608741afc4b62a749d = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_53ddecad911c3e608741afc4b62a749d]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_53ddecad911c3e608741afc4b62a749d]['form'] = $form;
}
...
{
$count_7e367e23703aebf56cc1d06bec732b2a = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_7e367e23703aebf56cc1d06bec732b2a]['data'] = $data;
}
...
{
$count_33891eaa3df1ecd8ab78bf9bde5a6880 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_33891eaa3df1ecd8ab78bf9bde5a6880]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__8a54700cd1f36715cb53d7f79a8cfdbb($posts)."") : ("")) . "
<p class='submit'>
...
function __f__8a54700cd1f36715cb53d7f79a8cfdbb($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d048dd41a4abdba35bee35aa3a3a8200 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_d048dd41a4abdba35bee35aa3a3a8200]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_d048dd41a4abdba35bee35aa3a3a8200]['type'] = $type;
$this->functionData['uploadForm'][$count_d048dd41a4abdba35bee35aa3a3a8200]['stats'] = $stats;
$this->functionData['uploadForm'][$count_d048dd41a4abdba35bee35aa3a3a8200]['id'] = $id;
$this->functionData['uploadForm'][$count_d048dd41a4abdba35bee35aa3a3a8200]['forum_id'] = $forum_id;
}
