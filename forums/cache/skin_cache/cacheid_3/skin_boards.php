...
{
$count_b2602b9d95f99f716189f912bfc84c2a = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_b2602b9d95f99f716189f912bfc84c2a]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_b2602b9d95f99f716189f912bfc84c2a]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_b2602b9d95f99f716189f912bfc84c2a]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_b2602b9d95f99f716189f912bfc84c2a]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_b2602b9d95f99f716189f912bfc84c2a]['side_blocks'] = $side_blocks;
}
...
" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		<categories>
		".$this->__f__882ec9d565ebb02db2c69446603b0881($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</categories>
	") : ("")) . "
		<statistics>
...
function __f__cf34f533199f973b44ac54a367af19d0($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__aaa0576d07fc5c4aa108cbcb042820ff($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
	{
		...
		$_ips___x_retval .= "
					<forum>
						...
						<subforums>
											".$this->__f__cf34f533199f973b44ac54a367af19d0($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."						</subforums>
						") : ("")) . "
					</forum>
...
function __f__882ec9d565ebb02db2c69446603b0881($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			...
			<category>
				...
				<forums>
						".$this->__f__aaa0576d07fc5c4aa108cbcb042820ff($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."				</forums>
			</category>
			") : ("")) . "
...
{
$count_6c7cbeb41cc9f7f2e5a8fae5b4226baa = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_5944bfea17e8c41c3d3f7e0a6437a27f = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_5944bfea17e8c41c3d3f7e0a6437a27f]['topics'] = $topics;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_b48311f8d5e6ea6417fd9e12fd711d2b = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_b48311f8d5e6ea6417fd9e12fd711d2b]['tags'] = $tags;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_0ec573952d38b1648d45cd2e0aa6605c = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_0ec573952d38b1648d45cd2e0aa6605c]['replies'] = $replies;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
...
{
$count_4c1f7d07467f88d93cb65b500a02956d = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_4c1f7d07467f88d93cb65b500a02956d]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_4c1f7d07467f88d93cb65b500a02956d]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_4c1f7d07467f88d93cb65b500a02956d]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<!-- NoData -->";
return $IPBHTML;
}
