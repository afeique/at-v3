...
{
$count_b1004e7bddc8b77ac531ee2a4592a257 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_b1004e7bddc8b77ac531ee2a4592a257]['members'] = $members;
$this->functionData['member_list_show'][$count_b1004e7bddc8b77ac531ee2a4592a257]['pages'] = $pages;
$this->functionData['member_list_show'][$count_b1004e7bddc8b77ac531ee2a4592a257]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_b1004e7bddc8b77ac531ee2a4592a257]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_b1004e7bddc8b77ac531ee2a4592a257]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_b1004e7bddc8b77ac531ee2a4592a257]['url'] = $url;
}
$IPBHTML .= "<template>memberList</template>
{$pages}
" . ((is_array( $members ) and count( $members )) ? ("
	<members>
	".$this->__f__81701337afd934bedf5241acffa0bbcd($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."	</members>
") : ("")) . "";
return $IPBHTML;
}


function __f__81701337afd934bedf5241acffa0bbcd($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
