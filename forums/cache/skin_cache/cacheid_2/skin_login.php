...
{
$count_1089ff5a82c704d13daa849a654d75df = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
{
$count_838bdfbe4ecd22d178f2e4eab994d8c0 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_838bdfbe4ecd22d178f2e4eab994d8c0]['message'] = $message;
$this->functionData['showLogInForm'][$count_838bdfbe4ecd22d178f2e4eab994d8c0]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_838bdfbe4ecd22d178f2e4eab994d8c0]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_838bdfbe4ecd22d178f2e4eab994d8c0]['login_methods'] = $login_methods;
}
