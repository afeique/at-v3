...
{
$count_b742d40b2dfe5e9455b19ced7d4dee5e = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['html'] = $html;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['css'] = $css;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['items'] = $items;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_b742d40b2dfe5e9455b19ced7d4dee5e]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__b711c28df950d0872f96c02ee3f67787($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__b711c28df950d0872f96c02ee3f67787($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cbc82a25096bc92202c205768de86593 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_cbc82a25096bc92202c205768de86593]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__558db92a20d377530d01040811de139e($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__2e5ac70a97a605e9a70f5b844609a944($css)."") : ("")) . "";
return $IPBHTML;
}


function __f__558db92a20d377530d01040811de139e($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2e5ac70a97a605e9a70f5b844609a944($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3b2d7d00efa8f8a0608e6ebbadcffbf7 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_3b2d7d00efa8f8a0608e6ebbadcffbf7]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__34cf8f10e8cb186a2e84384b83b1fa90($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__0e91c3cb4819ca487eeacd531ad36081($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__34cf8f10e8cb186a2e84384b83b1fa90($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__0e91c3cb4819ca487eeacd531ad36081($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_c680bd81d2fb7224f965ee55f6e020cf = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_c680bd81d2fb7224f965ee55f6e020cf]['jsModules'] = $jsModules;
}
...
{
$count_3b0b3b8bdff83ba0fd74ac756a8c557d = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_3b0b3b8bdff83ba0fd74ac756a8c557d]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__e793b99dee3742bb9fd95cd9404e394f($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__96690b2733fe8d2bd8ef9983ea394e51($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e793b99dee3742bb9fd95cd9404e394f($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__96690b2733fe8d2bd8ef9983ea394e51($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_825c054cdfd565dfb90eabec62b75741 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__2fa1addbc06e3ba0f3b875a6c02a86f3()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__2fa1addbc06e3ba0f3b875a6c02a86f3()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1e768b205a04363787a70bb17a660210 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_1e768b205a04363787a70bb17a660210]['header_items'] = $header_items;
}
...
{
$count_427dfe0a068441e682e9d680d6b5f740 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_d4c0e1aeb346c1339032efbb5bc90434 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_375cd5a0984046272ab163fa612dd90d = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_375cd5a0984046272ab163fa612dd90d]['data'] = $data;
}
...
{
$count_6d51456dee0f4fdad1cc961bc3a7ea4d = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_6d51456dee0f4fdad1cc961bc3a7ea4d]['work'] = $work;
$this->functionData['paginationTemplate'][$count_6d51456dee0f4fdad1cc961bc3a7ea4d]['data'] = $data;
}
...
{
$count_1fa5610c4c576393a18ee8dc54c124ff = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
...
{
$count_5073a9b8330d9a6d142b9efabff9f9f5 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_5073a9b8330d9a6d142b9efabff9f9f5]['links'] = $links;
$this->functionData['shareLinks'][$count_5073a9b8330d9a6d142b9efabff9f9f5]['title'] = $title;
$this->functionData['shareLinks'][$count_5073a9b8330d9a6d142b9efabff9f9f5]['url'] = $url;
$this->functionData['shareLinks'][$count_5073a9b8330d9a6d142b9efabff9f9f5]['cssClass'] = $cssClass;
}
$IPBHTML .= "&nbsp;";
return $IPBHTML;
}
...
{
$count_bc8f230ca1154d383d7f224d74abb173 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_bc8f230ca1154d383d7f224d74abb173]['sig'] = $sig;
$this->functionData['signature_separator'][$count_bc8f230ca1154d383d7f224d74abb173]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_bc8f230ca1154d383d7f224d74abb173]['can_ignore'] = $can_ignore;
}
...
{
$count_d88629add33041e3a75c1e6c27410099 = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_d88629add33041e3a75c1e6c27410099]['member'] = $member;
}
...
{
$count_a4f6f9b9a69c4546fd7dd2e77646af5c = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_a4f6f9b9a69c4546fd7dd2e77646af5c]['author'] = $author;
$this->functionData['userInfoPane'][$count_a4f6f9b9a69c4546fd7dd2e77646af5c]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_a4f6f9b9a69c4546fd7dd2e77646af5c]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		" . (($author['custom_fields'] != "") ? ("
			".$this->__f__b33e83b3f418780c5f08860c9ca8c127($author,$contentid,$options)."		") : ("")) . "
	</ul>
...
function __f__ac0ec5e1ea5afee09f81270ff45881f4($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b33e83b3f418780c5f08860c9ca8c127($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__ac0ec5e1ea5afee09f81270ff45881f4($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_3e1c3799bf5cf80cc6848fb0c422774b = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_3e1c3799bf5cf80cc6848fb0c422774b]['member'] = $member;
}
...
{
$count_033e05a2a7496104c58836f427e231e6 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_033e05a2a7496104c58836f427e231e6]['warning'] = $warning;
$this->functionData['warnDetails'][$count_033e05a2a7496104c58836f427e231e6]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__fa5bebaa5d657f9612f246bcee50897d($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__fa5bebaa5d657f9612f246bcee50897d($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
