...
{
$count_d1fd58cf493e59877107b69b142203da = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_d1fd58cf493e59877107b69b142203da]['info'] = $info;
$this->functionData['coreAttachments'][$count_d1fd58cf493e59877107b69b142203da]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_d1fd58cf493e59877107b69b142203da]['attachments'] = $attachments;
}
...
$IPBHTML .= "<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__ca6bfee620f0b9139887adcaed6eb11e($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__ca6bfee620f0b9139887adcaed6eb11e($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6512827c5deeb2380c10687475eaf03c = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_6512827c5deeb2380c10687475eaf03c]['form'] = $form;
$this->functionData['displayNameForm'][$count_6512827c5deeb2380c10687475eaf03c]['error'] = $error;
$this->functionData['displayNameForm'][$count_6512827c5deeb2380c10687475eaf03c]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_6512827c5deeb2380c10687475eaf03c]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_f173c8fcccae5baba162ee228f85217d = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_f173c8fcccae5baba162ee228f85217d]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_f173c8fcccae5baba162ee228f85217d]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_f173c8fcccae5baba162ee228f85217d]['isFB'] = $isFB;
}
...
{
$count_0248558cb1537948f81e78365da409da = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_0248558cb1537948f81e78365da409da]['title'] = $title;
$this->functionData['field_entry'][$count_0248558cb1537948f81e78365da409da]['desc'] = $desc;
$this->functionData['field_entry'][$count_0248558cb1537948f81e78365da409da]['content'] = $content;
$this->functionData['field_entry'][$count_0248558cb1537948f81e78365da409da]['id'] = $id;
}
...
{
$count_116739d0a790eb6f1a5ec115445aa1fa = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_116739d0a790eb6f1a5ec115445aa1fa]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_116739d0a790eb6f1a5ec115445aa1fa]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_116739d0a790eb6f1a5ec115445aa1fa]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_116739d0a790eb6f1a5ec115445aa1fa]['perms'] = $perms;
}
...
{
$count_6203ec942f1d5aff465a0e33620db86f = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_6203ec942f1d5aff465a0e33620db86f]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_6203ec942f1d5aff465a0e33620db86f]['pagination'] = $pagination;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__adfb9057a75241df0dfad8db2477dd05($members,$pagination)."	</table>
    " . (($pagination) ? ("
	    <br />
	    {$pagination}
	    <br class='clear' />
...
function __f__adfb9057a75241df0dfad8db2477dd05($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_00fdd16ad26d418ec1da6177e70ee4d1 = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_00fdd16ad26d418ec1da6177e70ee4d1]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_00fdd16ad26d418ec1da6177e70ee4d1]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_00fdd16ad26d418ec1da6177e70ee4d1]['day'] = $day;
$this->functionData['membersProfileForm'][$count_00fdd16ad26d418ec1da6177e70ee4d1]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_00fdd16ad26d418ec1da6177e70ee4d1]['year'] = $year;
$this->functionData['membersProfileForm'][$count_00fdd16ad26d418ec1da6177e70ee4d1]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_00fdd16ad26d418ec1da6177e70ee4d1]['times'] = $times;
}
	...
	<ul>
		...
		" . (($day AND $mon AND $year) ? ("
			<li class='field'>
				...
				<select name=\"month\">&nbsp;
					".$this->__f__507b9876c23421c8c5739d455902b397($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select>			
				<select name=\"day\">&nbsp;
					".$this->__f__d090e12180bb14fd701714df44fc3a97($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> 
				<select name=\"year\">&nbsp;
					".$this->__f__c045ccdd8792e81102c4cf3f78051a21($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> <br />
...
function __f__507b9876c23421c8c5739d455902b397($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__d090e12180bb14fd701714df44fc3a97($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__c045ccdd8792e81102c4cf3f78051a21($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
{
$count_c78b900d9ef6f8bc8d40530b707d0acb = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_c78b900d9ef6f8bc8d40530b707d0acb]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_c78b900d9ef6f8bc8d40530b707d0acb]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_c78b900d9ef6f8bc8d40530b707d0acb]['signature'] = $signature;
}
...
{
$count_49361e8f84393b44688a5cbe35a11cd3 = is_array($this->functionData['membersTwitterConnect']) ? count($this->functionData['membersTwitterConnect']) : 0;
$this->functionData['membersTwitterConnect'][$count_49361e8f84393b44688a5cbe35a11cd3]['isConnected'] = $isConnected;
$this->functionData['membersTwitterConnect'][$count_49361e8f84393b44688a5cbe35a11cd3]['twitterUser'] = $twitterUser;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_c1468e9697b995c9d68a59bab3a47634 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_c1468e9697b995c9d68a59bab3a47634]['config'] = $config;
$this->functionData['notificationsForm'][$count_c1468e9697b995c9d68a59bab3a47634]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__531757717a2a7ec7e84785185421cab5($config,$emailData)."		".$this->__f__0012932d40414bfbc077191e2fe3a85d($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__93d93ad9d03932f6f39f9afaf7f0de20($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__531757717a2a7ec7e84785185421cab5($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__93d93ad9d03932f6f39f9afaf7f0de20($config,$emailData,$groupKey,$group)."							
...
function __f__0012932d40414bfbc077191e2fe3a85d($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e0b2c38fdb5eda2bac6fa02cf9e2f9cb = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_e0b2c38fdb5eda2bac6fa02cf9e2f9cb]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_e0b2c38fdb5eda2bac6fa02cf9e2f9cb]['error'] = $error;
$this->functionData['notificationsLog'][$count_e0b2c38fdb5eda2bac6fa02cf9e2f9cb]['pages'] = $pages;
}
...
$IPBHTML .= "<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=removeNotifications&amp;do=remove", "public",'' ), "", "" ) . "\" id=\"checkBoxForm\" method=\"post\">
	...
	<div class='master_list' id='notifications'>
		...
		") : ("" . (($this->request['confirm']) ? ("
			...
			") : ("")) . "")) . "
		".$this->__f__1a3f792ae4cef4791551b11aefcdf1c7($notifications,$error,$pages)."	</div>
	" . ((count($notifications)) ? ("
		<div class='submit'>
...
function __f__1a3f792ae4cef4791551b11aefcdf1c7($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_269fb4d0cd2c306eabcda95568d5a91a = is_array($this->functionData['userCPTemplate']) ? count($this->functionData['userCPTemplate']) : 0;
$this->functionData['userCPTemplate'][$count_269fb4d0cd2c306eabcda95568d5a91a]['current_tab'] = $current_tab;
$this->functionData['userCPTemplate'][$count_269fb4d0cd2c306eabcda95568d5a91a]['html'] = $html;
$this->functionData['userCPTemplate'][$count_269fb4d0cd2c306eabcda95568d5a91a]['tabs'] = $tabs;
$this->functionData['userCPTemplate'][$count_269fb4d0cd2c306eabcda95568d5a91a]['current_area'] = $current_area;
$this->functionData['userCPTemplate'][$count_269fb4d0cd2c306eabcda95568d5a91a]['errors'] = $errors;
$this->functionData['userCPTemplate'][$count_269fb4d0cd2c306eabcda95568d5a91a]['hide_form'] = $hide_form;
$this->functionData['userCPTemplate'][$count_269fb4d0cd2c306eabcda95568d5a91a]['maxUpload'] = $maxUpload;
}
$IPBHTML .= "{$html}";
return $IPBHTML;
}
