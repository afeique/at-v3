...
{
$count_0dc01f61d0a9567cdaa7cfe4da76cb3e = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_0dc01f61d0a9567cdaa7cfe4da76cb3e]['title'] = $title;
$this->functionData['forward_form'][$count_0dc01f61d0a9567cdaa7cfe4da76cb3e]['text'] = $text;
$this->functionData['forward_form'][$count_0dc01f61d0a9567cdaa7cfe4da76cb3e]['lang'] = $lang;
$this->functionData['forward_form'][$count_0dc01f61d0a9567cdaa7cfe4da76cb3e]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_0dc01f61d0a9567cdaa7cfe4da76cb3e]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__5c5c38ab3fc7ec0864ab4637778cc912($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__5c5c38ab3fc7ec0864ab4637778cc912($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
