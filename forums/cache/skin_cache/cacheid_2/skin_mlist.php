...
{
$count_30e3576b643f73840aecbf7c3a490cc8 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_30e3576b643f73840aecbf7c3a490cc8]['members'] = $members;
$this->functionData['member_list_show'][$count_30e3576b643f73840aecbf7c3a490cc8]['pages'] = $pages;
$this->functionData['member_list_show'][$count_30e3576b643f73840aecbf7c3a490cc8]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_30e3576b643f73840aecbf7c3a490cc8]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_30e3576b643f73840aecbf7c3a490cc8]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_30e3576b643f73840aecbf7c3a490cc8]['url'] = $url;
}
...
<div id=\"filter-letters\">
		".$this->__f__daaad469a3528d97d8a9ebbd766dee9d($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."</div>
</div>
	" . ((is_array( $members ) and count( $members )) ? ("
				".$this->__f__e908ebc802feb5ae16f26929060cc422($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."	") : ("
...
function __f__daaad469a3528d97d8a9ebbd766dee9d($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e908ebc802feb5ae16f26929060cc422($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
