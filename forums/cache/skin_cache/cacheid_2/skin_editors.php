...
{
$count_f57dd068a4b03da0ad9239eaa9f2d2cf = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_f57dd068a4b03da0ad9239eaa9f2d2cf]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_f57dd068a4b03da0ad9239eaa9f2d2cf]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_f57dd068a4b03da0ad9239eaa9f2d2cf]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_f57dd068a4b03da0ad9239eaa9f2d2cf]['extraData'] = $extraData;
}
...
{
$count_2751430be34eab1c35825154cfd7cfbf = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['formField'] = $formField;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['content'] = $content;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['options'] = $options;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_2751430be34eab1c35825154cfd7cfbf]['showEditor'] = $showEditor;
}
...
{
$count_a47aa244cabd4e3624969fcf0f5e8850 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_a47aa244cabd4e3624969fcf0f5e8850]['options'] = $options;
$this->functionData['editorLoadJs'][$count_a47aa244cabd4e3624969fcf0f5e8850]['inlineLoad'] = $inlineLoad;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_38607a6267606f23dd553e35265ee432 = is_array($this->functionData['editorSettings']) ? count($this->functionData['editorSettings']) : 0;
}
...
{
$count_2032a68c62e9d3a07e04e1a3704e2843 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_2032a68c62e9d3a07e04e1a3704e2843]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_2032a68c62e9d3a07e04e1a3704e2843]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_2032a68c62e9d3a07e04e1a3704e2843]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_2032a68c62e9d3a07e04e1a3704e2843]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__d8d277dd9c0d424577accfee49f55c1d($rows,$pages,$app,$plugin)."		") : ("
...
function __f__d8d277dd9c0d424577accfee49f55c1d($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_6841b7c63c1831b579a2da7010dbfa9a = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_6841b7c63c1831b579a2da7010dbfa9a]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__3c9d43cd5ae8f9535941f1916d55dfbb($tabs)."			</ul>
		</div>
...
function __f__3c9d43cd5ae8f9535941f1916d55dfbb($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
