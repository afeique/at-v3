...
{
$count_2d17812c2af5308463c9cef6c6bf1fa1 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_2d17812c2af5308463c9cef6c6bf1fa1]['data'] = $data;
}
...
{
$count_8c76d545dd968d1a6643a02f9ee9d6b1 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_8c76d545dd968d1a6643a02f9ee9d6b1]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_8c76d545dd968d1a6643a02f9ee9d6b1]['form'] = $form;
}
...
{
$count_e7333bab74df1731e46fbbccf1aa2528 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_e7333bab74df1731e46fbbccf1aa2528]['data'] = $data;
}
...
{
$count_c4c3dc787dbb60a43c7e9fc6049e944f = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_c4c3dc787dbb60a43c7e9fc6049e944f]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__9d259e102607ac03113c2cedf7079f64($posts)."") : ("")) . "
<p class='submit'>
...
function __f__9d259e102607ac03113c2cedf7079f64($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8a71bdd613654f3c7f3b86c3e2ba63e7 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_8a71bdd613654f3c7f3b86c3e2ba63e7]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_8a71bdd613654f3c7f3b86c3e2ba63e7]['type'] = $type;
$this->functionData['uploadForm'][$count_8a71bdd613654f3c7f3b86c3e2ba63e7]['stats'] = $stats;
$this->functionData['uploadForm'][$count_8a71bdd613654f3c7f3b86c3e2ba63e7]['id'] = $id;
$this->functionData['uploadForm'][$count_8a71bdd613654f3c7f3b86c3e2ba63e7]['forum_id'] = $forum_id;
}
