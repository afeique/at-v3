...
{
$count_e034385219d7392aeada46d2b0779fe7 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_e034385219d7392aeada46d2b0779fe7]['data'] = $data;
}
...
{
$count_0885fc55b4dab1a11e3125403b0591ff = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_0885fc55b4dab1a11e3125403b0591ff]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_0885fc55b4dab1a11e3125403b0591ff]['form'] = $form;
}
...
{
$count_72c437f3832a2463fad21d5d496784c1 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_72c437f3832a2463fad21d5d496784c1]['data'] = $data;
}
...
{
$count_ff0dae12ab300e1f65a8ffa6f73596fa = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_ff0dae12ab300e1f65a8ffa6f73596fa]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__d0d4b7e82a9a1f71b744c290f0b862e0($posts)."") : ("")) . "
<p class='submit'>
...
function __f__d0d4b7e82a9a1f71b744c290f0b862e0($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0687c5f42678bf5b859e6680e657d45c = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_0687c5f42678bf5b859e6680e657d45c]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_0687c5f42678bf5b859e6680e657d45c]['type'] = $type;
$this->functionData['uploadForm'][$count_0687c5f42678bf5b859e6680e657d45c]['stats'] = $stats;
$this->functionData['uploadForm'][$count_0687c5f42678bf5b859e6680e657d45c]['id'] = $id;
$this->functionData['uploadForm'][$count_0687c5f42678bf5b859e6680e657d45c]['forum_id'] = $forum_id;
}
