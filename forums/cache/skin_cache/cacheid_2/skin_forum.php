...
{
$count_cc86b166bd6a3cc3ff01d6306ee8c317 = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_cc86b166bd6a3cc3ff01d6306ee8c317]['title'] = $title;
$this->functionData['forumAttachments'][$count_cc86b166bd6a3cc3ff01d6306ee8c317]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_cc86b166bd6a3cc3ff01d6306ee8c317]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__bcf3614774efb59c5953993d91d75ae7($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__bcf3614774efb59c5953993d91d75ae7($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_11a6ca46c942a9d2c3f5c18cca325109 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_11a6ca46c942a9d2c3f5c18cca325109]['inforum'] = $inforum;
}
...
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
	<div class='master_list' id='board_index'>
		".$this->__f__c7b8be9904596a43ecd529e7e9d5b7c6($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</div>
") : ("")) . "
<div class='master_list'>
	" . (($forum_data['sub_can_post']) ? ("<!--<h2>{$forum_data['name']}</h2>-->
		...
		" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
			".$this->__f__d314db034c508e46115c0b9317bd60c1($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		") : ("")) . "
		
		" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
			<h3>{$this->lang->words['forum_topic_list']}</h3>
			".$this->__f__50dced1795f5c8b4eb72c149d94ba45e($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		") : ("
...
function __f__7e9e15503cbc16b16b2fae29eb2d077e($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c7b8be9904596a43ecd529e7e9d5b7c6($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__7e9e15503cbc16b16b2fae29eb2d077e($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."			") : ("")) . "
...
function __f__d314db034c508e46115c0b9317bd60c1($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__50dced1795f5c8b4eb72c149d94ba45e($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7cba85ebdc3d1cc40017edd0edac5b9b = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_7cba85ebdc3d1cc40017edd0edac5b9b]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_7cba85ebdc3d1cc40017edd0edac5b9b]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_7cba85ebdc3d1cc40017edd0edac5b9b]['opts'] = $opts;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_b6cd6883a891b7c3003cf751c137ab19 = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_b6cd6883a891b7c3003cf751c137ab19]['data'] = $data;
$this->functionData['topic'][$count_b6cd6883a891b7c3003cf751c137ab19]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_b6cd6883a891b7c3003cf751c137ab19]['other_data'] = $other_data;
$this->functionData['topic'][$count_b6cd6883a891b7c3003cf751c137ab19]['inforum'] = $inforum;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_3e45461bd95c435a9958eb67d917836c = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_3e45461bd95c435a9958eb67d917836c]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__b2c1732031cf85540058bf933246f80f($rating_id)."</span>";
return $IPBHTML;
}


function __f__b2c1732031cf85540058bf933246f80f($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_54d18d447fe072efd5df7c62ac06b226 = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_54d18d447fe072efd5df7c62ac06b226]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
