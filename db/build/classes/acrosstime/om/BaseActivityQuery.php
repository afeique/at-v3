 ...
 * @method ActivityQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method ActivityQuery groupById() Group by the id column
 * @method ActivityQuery groupByName() Group by the name column
 *
 ...
 *
 * @method ActivityQuery leftJoinUserTimelog($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserTimelog relation
 * @method ActivityQuery rightJoinUserTimelog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserTimelog relation
 * @method ActivityQuery innerJoinUserTimelog($relationAlias = null) Adds a INNER JOIN clause to the query using the UserTimelog relation
 *
 ...
 *
 * @method Activity findOneByName(string $name) Return the first Activity filtered by the name column
 *
 * @method array findById(int $id) Return Activity objects filtered by the id column
 * @method array findByName(string $name) Return Activity objects filtered by the name column
 *
...
abstract class BaseActivityQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'acrosstime', $modelName = 'Activity', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name` FROM `activities` WHERE `id` = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ActivityPeer::NAME, $name, $comparison);
    }
     ...
     */
    public function filterByUserTimelog($userActivityTimelog, $comparison = null)
    {
        if ($userActivityTimelog instanceof UserActivityTimelog) {
            return $this
                ->addUsingAlias(ActivityPeer::ID, $userActivityTimelog->getActivityId(), $comparison);
            ...
            throw new PropelException('filterByUserTimelog() only accepts arguments of type UserActivityTimelog or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the UserTimelog relation
     *
     ...
     * @return ActivityQuery The current query, for fluid interface
     */
    public function joinUserTimelog($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('UserTimelog');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'UserTimelog');
        }
    ...
    /**
     * Use the UserTimelog relation UserActivityTimelog object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useUserTimelogQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUserTimelog($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserTimelog', 'UserActivityTimelogQuery');
    }
