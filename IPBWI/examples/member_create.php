...
?>
		<form action="member_create.php" method="post">
			<table>
				...
				<td>
					<input type="hidden" value="<?php echo $question['qa_id']; ?>" name="qanda_id"><strong><?php echo $question['qa_question']; ?></strong><input class="input" type="text" name="qa_answer" value="">
					<p>This helps to protect us against spammers.</p>
				</td></tr>
				<?php
					}
				?>
